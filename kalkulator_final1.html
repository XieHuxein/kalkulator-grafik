...
<head>
  <meta charset="utf-8" />
  <title>Kalkulator Titik Diferensial — Final (Local)</title>
  <meta name="viewport" content="width=device-width,initial-scale=1" />
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body { padding:18px; }
    #chart { max-width:920px; height:440px; }
    .point-list { max-height:340px; overflow:auto; }
...
<body>
  <div class="container">
    ...
    <div class="mb-3">
      ...
      <!-- <div><small>Console (F12) menampilkan log loader & error.</small></div> -->
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div id="points" class="point-list list-group"></div>
      </div>
    </div>
  </div>
  ...
  (async function startup(){
    ...
    // now call app initializer with info about libs
    initApp({
